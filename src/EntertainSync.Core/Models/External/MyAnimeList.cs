...
namespace EntertainSync.Core.Models.External;

public record MyAnimeList(
    [property: JsonPropertyName("data")] IReadOnlyList<MyAnimeListData> Data,
...
public record Broadcast(
    [property: JsonPropertyName("day_of_the_week")]
    string DayOfTheWeek,
    [property: JsonPropertyName("start_time")]
    string StartTime
);

public record MyAnimeListData(
...
public record Node(
    ...
    [property: JsonPropertyName("main_picture")]
    MainPicture MainPicture,
    [property: JsonPropertyName("alternative_titles")]
    ...
    int Popularity,
    [property: JsonPropertyName("num_list_users")]
    int NumListUsers,
    [property: JsonPropertyName("num_scoring_users")]
    int NumScoringUsers,
    ...
    [property: JsonPropertyName("num_episodes")]
    int NumEpisodes,
    [property: JsonPropertyName("start_season")]
    StartSeason StartSeason,
    [property: JsonPropertyName("broadcast")]
    Broadcast Broadcast,
    [property: JsonPropertyName("source")] string Source,
    [property: JsonPropertyName("average_episode_duration")]
